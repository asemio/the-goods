...
RUN curl https://releases.hashicorp.com/terraform/0.12.28/terraform_0.12.28_linux_amd64.zip -o terraform_0.12.28_linux_amd64.zip \
  && unzip terraform_0.12.28_linux_amd64.zip -d terraform
