...
RUN curl https://releases.hashicorp.com/terraform/0.12.18/terraform_0.12.18_linux_amd64.zip -o terraform_0.12.18_linux_amd64.zip \
  && unzip terraform_0.12.18_linux_amd64.zip -d terraform
